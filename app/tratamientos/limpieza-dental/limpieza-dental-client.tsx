        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-44 pb-40 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-secondary-light leading-relaxed max-w-xl">
              Transforma tu sonrisa con un blanqueamiento dental profesional en consultorio. Aclaramos tus dientes de
              forma segura y efectiva en una sola cita. Eliminando manchas profundas Causadas por alimentos y hábitos.
            ...
            {technologies.map((tech, index) => (
              ...
              >
                <div>
                  ...
                  />
                  <h3 className="text-xl md:text-2xl font-normal text-primary-dark mb-4 mt-8 leading-tight">
                    {tech.title}
                  </h3>
